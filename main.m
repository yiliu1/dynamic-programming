...
if transitionProbabilitiesImplemented
    ...
    P2=ComputeTransitionProbabilities2( stateSpace, controlSpace, ...
       map, gate, mansion, cameras );
end
...
if stageCostsImplemented 
    ...
    G = ComputeStageCosts( stateSpace, controlSpace, ...
        map, gate, mansion, cameras );
    G2=ComputeStageCosts2( stateSpace, controlSpace, ...
        map, gate, mansion, cameras );
end
...
if valueIterationImplemented
    ...
    %[ J_opt_vi2, u_opt_ind_vi2 ] = ValueIteration( P2, G2);
end
...
if policyIterationImplemented
    ...
    %[ J_opt_pi2, u_opt_ind_pi2 ] = PolicyIteration( P2, G2 );
end
...
if linearProgrammingImplemented
    ...
    %[ J_opt_lp2, u_opt_ind_lp2 ] = LinearProgramming2( P2, G2 );
end
...
disp('terminated');
disp('find(abs(J_opt_lp-J_opt_vi)>0.00001')
disp('find(abs(J_opt_pi-J_opt_lp)>0.00001')
disp('find(abs(J_opt_vi-J_opt_pi)>0.00001')
test